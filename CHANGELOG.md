...
## [0.8.2](https://github.com/krtab/petgraph/compare/petgraph@v0.8.1...petgraph@v0.8.2) - 2025-05-14

### Documentation

- Specify that Acyclic::try_udpate_edge may add an edge ([#770](https://github.com/krtab/petgraph/pull/770))

### New Features

- *(parser)* allow parsing graphs from Dot/Graphviz files ([#653](https://github.com/krtab/petgraph/pull/653))
- Implement `DataMap` for `GraphMap` graphs ([#776](https://github.com/krtab/petgraph/pull/776))
